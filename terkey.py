...
class Terkey:
  ...
  def banner(self):
      ...
      print(f'{a}JARLIK BNGST - CYBER'.center(53))
  ...
  def about(self):
    ...
    A program from {a}jbmods cyber{c} for you.
    ...
    {a}https://www.instagram.com/bngst.story{c}
    My Web Site
    {a}https://jbmodsofficial.blogspot.com/{c}
    And if you want to give me some money, you can visit
    {a}https://trakteer.id/jbmods-cyber{c}
  ...
  {a}3.{c} About
    ...
    if menu == "1":
      ...
      pass
    #print(c+'Silahkan hubungi '+a+'https://www.instagram.com/bngst.story'+c+' jika ada yang mau di bicarakan terkait tool ini atau sekedar bertanya kabar. :v\nTerimakasih ^_^')
